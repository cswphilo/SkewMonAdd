...
pass-ri∧r* fs (conj {Φ} {Ψ} {A' = A'} {B'} SF1 SF2) with fsDist-white (A' ∷ Φ) (B' ∷ Ψ) fs refl
... | fs1 , fs2 , refl 
...
Il-ri∧r* fs (conj {Φ} {Ψ} {A' = A'} {B'} SF1 SF2) with fsDist-white (A' ∷ Φ) (B' ∷ Ψ) fs refl
... | fs1 , fs2 , refl  
...
... | _ , f1 ∷ fs , SF , refl 
  rewrite Il-ri∧r* (f1 ∷ fs) SF |
          f2fs-refl (Il f1) (Il-fs fs) SF refl |
...
⊗l-ri∧r* fs (conj {Φ} {Ψ} {A' = A'} {B'} SF1 SF2) with fsDist-white (A' ∷ Φ) (B' ∷ Ψ) fs refl
... | fs1 , fs2 , refl  
...
... | _ , f1 ∷ fs , SF , refl 
  rewrite ⊗l-ri∧r* (f1 ∷ fs) SF |
          f2fs-refl (⊗l f1) (⊗l-fs fs) SF refl |
          ⊗l-inv-fs-eq fs = refl
...
∧l₁-ri∧r* {B = B} fs (conj {Φ} {Ψ} {A' = A'} {B'} SF1 SF2) with fsDist-white (A' ∷ Φ) (B' ∷ Ψ) fs refl
... | fs1 , fs2 , refl 
...
∧l₂-ri∧r* {A = A} fs (conj {Φ} {Ψ} {A' = A'} {B'} SF1 SF2) with fsDist-white (A' ∷ Φ) (B' ∷ Ψ) fs refl
... | fs1 , fs2 , refl 
...
fs-succ-eq : {Γ : Cxt} {A A' B' : Fma}
  ...
  → Φ1 ≡ Φ2
fs-succ-eq fs1 fs2 (conj {Φ1} {Ψ1} {A' = A1} {B1} SF1 SF1') (conj {Φ2} {Ψ2} {A' = A2} {B2} SF2 SF2') refl refl with fsDist-white (A1 ∷ Φ1) (B1 ∷ Ψ1) fs1 refl | fsDist-white (A2 ∷ Φ2) (B2 ∷ Ψ2) fs2 refl
...
SF-eq fs1 fs2 (conj {Φ1} {Ψ1} {A' = A1} {B1} SF1 SF1') (conj {Φ2} {Ψ2} {A' = A2} {B2} SF2 SF2') eq1 eq2 eq3 with fsDist-white (A1 ∷ Φ1) (B1 ∷ Ψ1) fs1 refl | fsDist-white (A2 ∷ Φ2) (B2 ∷ Ψ2) fs2 refl
SF-eq .(All++ fs1' fs1'') .(All++ fs2' fs2'') (conj {Φ1} {Ψ1} {A' = _} {B1} SF1 SF1') (conj {Φ2} {Ψ2} {A' = _} {B2} SF2 SF2') refl refl eq3 | fs1' , fs1'' , refl | fs2' , fs2'' , refl with fs-succ-eq fs1' fs2' SF1 SF2 refl refl | fs-succ-eq fs1'' fs2'' SF1' SF2' refl refl
SF-eq .(All++ fs1' fs1'') .(All++ fs2' fs2'') (conj {Φ1} {Ψ1} {A' = _} {B1} SF1 SF1') (conj {.Φ1} {.Ψ1} {A' = _} {.B1} SF2 SF2') refl refl refl | fs1' , fs1'' , refl | fs2' , fs2'' , refl | refl | refl 
...
∨l-ri-∧r* fs1 fs2 (conj {Φ} {Ψ} {A' = A'} {B'} SF1 SF2) with fsDist-white (A' ∷ Φ) (B' ∷ Ψ) fs1 refl | fsDist-white (A' ∷ Φ) (B' ∷ Ψ) fs2 refl
... | fs1' , fs1'' , refl | fs2' , fs2'' , refl 
